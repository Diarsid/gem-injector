...
#### Common usage
##### Simple modular app [up](#gem-injector-tutorial)
...
##### Dependency graph and constructor injection [up](#gem-injector-tutorial)
...
##### Module and Container usage [up](#gem-injector-tutorial)
...
#### Module Builders [up](#gem-injector-tutorial)
...
##### ModuleBuilder interface [up](#gem-injector-tutorial)
...
##### Module Builder restrictions [up](#gem-injector-tutorial)
...
#### Other
##### Module Types [up](#gem-injector-tutorial)
...
##### Cyclic dependencies [up](#gem-injector-tutorial)
